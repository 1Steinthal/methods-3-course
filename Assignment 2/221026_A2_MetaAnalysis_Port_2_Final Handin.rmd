...
#c(mean(d$participants), sd(d$participants), min(d$participants), max(d$participants))
...
# Investigating participants
dens_n <- density(df_sub$n)
plot(dens_n)

c(mean(df_sub$n), sd(df_sub$n), min(df_sub$n), max(df_sub$n))
